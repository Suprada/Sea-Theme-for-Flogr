 ...
 * Site settings
 */
REQUIRED_SETTING('SITE_TITLE',         'Sea Theme Demo');
REQUIRED_SETTING('SITE_DESCRIPTION',   'A photoblog application built on Flickr');
REQUIRED_SETTING('SITE_THEME',         'sea');
 ...
 */
REQUIRED_SETTING('FLOGR_PHOTO_QUALITY', 'Large');

/* Desired width of main photo */
REQUIRED_SETTING('FLOGR_MAIN_PHOTO_SIZE', 1000);
 ...
 * it can take considerably longer to download high resolution original photos.
 */
REQUIRED_SETTING('FLOGR_SLIDESHOW_PHOTO_QUALITY', 'Large');
